        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    ...
                    _c.label = 5;
                case 5: return [2 /*return*/, (<div key={"card-".concat(rowIndex, "-").concat(componentIndex)} className={"relative ".concat(effectiveTheme.className, " ").concat(ts(effectiveTheme, "containerStyle"))}>
