...
function initMe(carouselElementId, options, animation, indicators) {
...
export function CarouselClientSide(props) {
    ...
    if (typeof window !== 'undefined') {
        ...
        if (document.readyState === "complete" || document.readyState === "interactive") {
            ...
            setTimeout(function () { return initMe(carouselElementId, options, animation, indicators); }, 1);
        }
        else {
            document.addEventListener("DOMContentLoaded", function () { return initMe(carouselElementId, options, animation, indicators); });
        }
    }
