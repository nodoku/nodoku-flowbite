...
export function resolve(specifier, context, nextResolve) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, nextResolve(specifier, context, nextResolve)];
        });
    });
}
export function load(url, context, nextLoad) {
    return __awaiter(this, void 0, void 0, function () {
        var prefix, filePath, file, templateContent, _a, _b, _c, line, e_1_1, src, res;
        var _d, e_1, _e, _f;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    console.log("loading ... Take a resolved URL and return the source code to be evaluated.", url, context, nextLoad);
                    if (!url.endsWith(".yml")) return [3 /*break*/, 14];
                    prefix = path.resolve("./");
                    filePath = nodeUrl.fileURLToPath(url);
                ...
                case 4:
                    ...
                    _a = false;
                    line = _f;
                    templateContent.push("\"".concat(line.replaceAll("\"", "\\\""), "\""));
                ...
                case 13:
                    ...
                    src = "const l = \"ksks; export default l;";
                    ...
                    return [2 /*return*/, res];
                case 14: return [2 /*return*/, nextLoad(url, context, nextLoad)];
            }
        });
    });
}
